...
// Load this file's selection again by visiting: http://mootools.net/more/169c3bc30a6b05ac1ee09344027d5923 
// Or build this file again with packager using: packager build More/More More/Events.Pseudos More/Array.Extras More/String.Extras More/String.QueryString More/Element.Delegation More/Element.Shortcuts More/Fx.SmoothScroll
/*
---
copyrights:
...
}).join("&");}});(function(){var d={},c=["once","throttle","pause"],b=c.length;while(b--){d[c[b]]=Events.lookupPseudo(c[b]);}Event.definePseudo=function(e,f){d[e]=Type.isFunction(f)?{listener:f}:f;
